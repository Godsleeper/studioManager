...
const TManageSider = () => {
    ...
    return (
        ...
        >
            ...
            <SubMenu key="student" title={<span><Icon type="smile-o" />学生培养</span>}>
                <Menu.Item key="studentAdd">
                    <Link to="/student/studentAdd">学生添加</Link>
                </Menu.Item>
                <Menu.Item key="studentEdit">
                    <Link to="/student/studentEdit">学生管理</Link>
                </Menu.Item>
            </SubMenu>
        </Menu>
    );
