...
import SiderMenu from '../components/layout/tManageSider.jsx';
import TopNav from '../components/layout/topNav.jsx';

import PersonInfo from '../components/manage/teacher/personInfo.jsx';
...
import StudentAdd from '../components/manage/teacher/studentAdd.jsx';
import StudentEdit from '../components/manage/teacher/studentEdit.jsx';
            ...
            <Layout className="man_wrapper">
                ...
                <Layout>
                    ...
                    <Content className="man_content_wrapper">
                        ...
                        <Route path="/student/studentAdd" render={()=>(
                            <Card>
                                <StudentAdd type="add"/>
                            </Card>)} />
                        <Route path="/student/studentEdit" render={()=>(<Card><StudentEdit /></Card>)} />
                    </Content>
                </Layout>
