...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SManage = __webpack_require__(1035);

	var _SManage2 = _interopRequireDefault(_SManage);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ROOT = document.getElementById('sManageRoot');

	_reactDom2.default.render(_react2.default.createElement(
	    _reactRouterDom.BrowserRouter,
	    { basename: '/smanage' },
	    _react2.default.createElement(_reactRouterDom.Route, { path: '/', component: _SManage2.default })
	), ROOT);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sManageSider = __webpack_require__(1036);

	var _sManageSider2 = _interopRequireDefault(_sManageSider);

	var _topNav = __webpack_require__(1010);

	var _topNav2 = _interopRequireDefault(_topNav);

	var _personInfo = __webpack_require__(1039);
	...
	var _jobInfo = __webpack_require__(1048);

	var _jobInfo2 = _interopRequireDefault(_jobInfo);

	var _jobEdit = __webpack_require__(1049);

	var _jobEdit2 = _interopRequireDefault(_jobEdit);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        { breakpoint: 'lg',
	                            collapsedWidth: '0' },
	                        _react2.default.createElement(_sManageSider2.default, null)
	                    ),
	                    _react2.default.createElement(
	                        Content,
	                        ...
	                        _react2.default.createElement(_reactRouterDom.Route, { path: '/job/jobAdd', render: function render() {
	                                return _react2.default.createElement(
	                                    _antd.Card,
	                                    null,
	                                    _react2.default.createElement(_jobInfo2.default, { type: 'add' })
	                                );
	                            } }),
	                        _react2.default.createElement(_reactRouterDom.Route, { path: '/job/jobEdit', render: function render() {
	                                return _react2.default.createElement(
	                                    _antd.Card,
	                                    null,
	                                    _react2.default.createElement(_jobEdit2.default, null)
	                                );
	                            } })
	                    )
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TManageSider = function TManageSider() {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            SubMenu,
	            { key: 'job', title: _react2.default.createElement(
	                    'span',
	                    null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./sManageSider.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./sManageSider.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	var RegistrationForm = function (_React$Component) {
	    ...
	    _createClass(RegistrationForm, [{
	        ...
	        value: function infoAdd(data) {
	            _axios2.default.post('/student/personInfoAdd', { info: data }).then(function (res) {
	        ...
	        value: function infoModify(data) {
	            _axios2.default.post('/student/personInfoModify', { info: data }).then(function (res) {
	                switch (res.data.status) {
	                    case 'NoInfo':
	                        _antd.message.error('请直接填写个人资料');
	                        break;
	                    case 'Success':
	        ...
	        value: function infoRequest() {
	            ...
	            _axios2.default.get('/student/personInfoGet').then(function (res) {
	                if (res.data) {
	                    _this2.setState({
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    getFieldDecorator('degree', {
	                        rules: [{ required: true, message: '请选择你的学位' }],
	                        initialValue: this.state.info.degree
	                    })(_react2.default.createElement(
	                        _antd.Select,
	                        { placeholder: '\u8BF7\u9009\u62E9\u4F60\u7684\u5B66\u4F4D' },
	                        _config2.default.studentPosition.map(function (item, index) {
	                            return _react2.default.createElement(
	                                Option,
	                                { key: index, value: item },
	                                item
	...
	var RegistrationForm = function (_React$Component) {
	    ...
	    function RegistrationForm(props) {
	        ...
	        _this.handleSubmit = function (e) {
	            ...
	            _this.props.form.validateFieldsAndScroll(function (err, values) {
	                if (!err) {
	                    switch (_this.props.type) {
	                        case 'add':
	                            _this.jobInfoAdd(values);
	                            break;
	                        case 'modify':
	                            _this.jobInfoModify(values);
	                            break;
	                    }
	                }
	            });
	        ...
	        switch (_this.props.type) {
	            ...
	            case 'modify':
	                _this.state = {
	                    info: _this.standardData(_this.props.info)
	                };
	                break;
	        }
	        return _this;
	    ...
	    _createClass(RegistrationForm, [{
	        ...
	        value: function standardData(data) {
	            ...
	            data.range.forEach(function (item) {
	                dataArr.push((0, _moment2.default)(item, 'YYYY-MM-DD'));
	            });
	            return {
	                name: data.name,
	        ...
	        key: 'jobInfoAdd',
	        value: function jobInfoAdd(data) {
	            _axios2.default.post('/job/addInfo', { job: data }).then(function (res) {
	                var status = res.data.status;

	                switch (status) {
	                    case 'NotStudent':
	                        _antd.message.error('不是学生用户');
	                        break;
	                    case 'NoInfo':
	        ...
	        key: 'jobInfoModify',
	        value: function jobInfoModify(data) {
	            data.paperId = this.props.info._id;
	            _axios2.default.post('/job/addInfo', { job: data }).then(function () {
	                _antd.message.success('success');
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    })(_react2.default.createElement(_antd.Input, { type: 'textarea', placeholder: '\u516C\u53F8\u8BE6\u7EC6\u5730\u5740', autosize: { minRows: 2, maxRows: 6 } }))
	                ),
	                _react2.default.createElement(
	                    FormItem,
	                    _extends({}, formItemLayout, {
	                ...
	                _react2.default.createElement(
	                    ...
	                    })(_react2.default.createElement(_antd.DatePicker.RangePicker, null))
	                ),
	                _react2.default.createElement(
	                    FormItem,
	                    _extends({}, formItemLayout, {
	                ...
	                _react2.default.createElement(
	                    ...
	                    })(_react2.default.createElement(_antd.Input, { type: 'textarea', placeholder: '\u5DE5\u4F5C\u5177\u4F53\u5185\u5BB9', autosize: { minRows: 2, maxRows: 6 } }))
	                ),
	                _react2.default.createElement(
	                    FormItem,
	                    tailFormItemLayout,
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_jobInfo2.default, { type: 'modify', info: this.props.info })
	                )
	            );
	        }
	    }]);
	...
	var EditableTable = function (_React$Component2) {
	    ...
	    function EditableTable(props) {
	        ...
	        _this2.onDelete = function (index, id) {
	            ...
	            dataSource.splice(index, 1);
	            _this2.setState({ dataSource: dataSource });
	            _axios2.default.delete('/job/jobRemove?jobId=' + id);
	        };
	    ...
	    _createClass(EditableTable, [{
	        ...
	        value: function dataFormat(data) {
	            data.forEach(function (item, index) {
	                item.stringTime = (0, _moment2.default)(item.range[0]).format('YYYY-MM-DD');
	                item.key = index;
	            });
	            return data;
	        }
	        ...
	        value: function getAllPaperInfo() {
	            ...
	            _axios2.default.get('/job/getInfoById').then(function (res) {
	                _this3.setState({
	                    dataSource: _this3.dataFormat(res.data.jobs),
	                    loading: false
	                });
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./sManage.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./sManage.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
